...
public class AcronymProvider extends ContentProvider {
        ...
        case ACRONYMS:
            ...
            try {
                ...
                for (ContentValues cv : contentValues) {
                    long insert = db.insert(AcronymContract.AcronymEntry.TABLE_NAME, null, cv);
                    if (insert != -1) {
                        returnCount++;
                    }
                }
    ...
    public Cursor query(Uri uri,
        ...
        case ACRONYM: 
            ...
            retCursor = db.query(AcronymContract.AcronymEntry.TABLE_NAME, projection, rowId, null, null, null, sortOrder);
            break;
        default:
            throw new UnsupportedOperationException("Unknown uri: " 
                                                    + uri);
